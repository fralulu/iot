 ...
 * @Title: sdf
 * @Package org.apache.ibatis.binding
 * @Description: 重写mybatis MapperMethod.class 实现多数据库兼容
...
public class MapperMethod {
  ...
  public static class SqlCommand {
    ...
    public SqlCommand(Configuration configuration, Class<?> mapperInterface, Method method) {
      try {
        Field field = mapperInterface.getField(BaseConstants.DB_TYPE);
        dbType = (String) field.get(field.getName());
      } catch (Exception e) {
        e.printStackTrace();
      }
      String statementName = mapperInterface.getName() + "." + method.getName();
      String statementName4db = mapperInterface.getName() + "." + method.getName() + "4" + this.dbType;

      MappedStatement ms = null;
      statementName = configuration.hasStatement(statementName4db) ? statementName4db : statementName;
