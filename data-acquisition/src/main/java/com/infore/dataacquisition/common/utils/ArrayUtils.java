...
public class ArrayUtils {
	...
	/**
	 * 将List<Object[]>转换为Map，取Object[]中第0个元素作为key
	 * 第1个元素作为Value，长度<2则舍弃
	 * @author 黄晓峰
	 * @Datetime 2015-5-21
	 * @param list
	 * @param K	指定Map的Key类型
	 * @param V	指定Mpa的Value类型
	 * @return Map<K,V>
	 */
	@SuppressWarnings("unchecked")
	public static <K, V> Map<K, V> toMap(List<Object[]> list, Class K, Class V) {
		if ( list == null ) {
			return null;
		}
	...
	public static boolean[] add(boolean[] array, int index, boolean element) {
		Boolean flag = element ? Boolean.TRUE : Boolean.FALSE;
		return (boolean[]) add(array, index, flag, Boolean.TYPE);
	}
