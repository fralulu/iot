package com.infore.platform.core.common.utils.uuid;
...
public class UUIDGenerator {
    ...
    private static final TimeBasedGenerator V1_GENERATOR = Generators.timeBasedGenerator();

    public static UUID getUUIDV1() {
        return V1_GENERATOR.generate();
    }
